...
urlpatterns = [
    ...
    path('earthranger/events/', ListEventsView.as_view(), name='events-list'),    
    # List events for specific setting
    path('earthranger/settings/<int:settings_id>/events/', ListEventsView.as_view(), name='setting-events-list'),
    path(

...
def te_spatial_analysis_dict(countries, start_date=None, end_date=None):
    ...
    :param start_date: Unused; kept for API consistency with
        other spatial dicts.
    ...
    ldn_image = ee.Image(
        ...
        'sdg_indicator_15_3_1_status_in_2023_compared_to_2000_2015_baseline'
    )
    ...
    return {
        'SDG Indicator 15.3.1 status in 2023 (compared to 2000-2015 baseline)': ldn_image  # noqa
    }
